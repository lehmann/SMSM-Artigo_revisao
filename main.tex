...
\centerline{
  \begin{tabular}{|l|c|c|c|}
  	\hline
        ...
        \makecell{$<$\textbf{Home}, Edu Vieira, \textbf{Coffee}$>$ \\ $[$8:00pm-8:00am$]$~~$[$8:50am-10:00am$]$ \\ (96,215)~~~~~~~~~~~~~~~~~~~~(182,201)} & 
      ...
      \makecell{$<$\textbf{Home}, Beira-mar, \textbf{Gym}$>$\\ $[$7:00pm-7:00am$]$~~$[$7:30am-8:30am$]$ \\ (13,81)~~~~~~~~~~~~~~~(268,63)}
      				&0.17&0&0.25\\
      \makecell{$<$\textbf{Gym}, Edu Vieira, \textbf{Coffee}$>$\\ $[$7:30am-8:30am$]$~~$[$8:45am-9:55pm$]$ \\ (268,63)~~~~~~~~~~~~~~~~~~(182,201)}
      				&0.25&0&0\\
...
\subsection{Paramenter  Analysis}\label{sec:sensitivity}
...
\hl{\subsection{Parameters and Weights}
